...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate var navigator: NavigationServiceType?
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let factory = PresentationFactory(window: window)
...
//        let route = Navigation.Route.topArtists
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplicationOpenURLOptionsKey : Any] = [:]) -> Bool {
        let factory = PresentationFactory(window: window)
        let presenter = factory.createNavigationPresenter()
        self.navigator?.open(url, presenter: presenter)

        // FIXME: App accepts all deeplinks - we should add checking here for valid routes and return result.
        return true
    }
